export const aiMlProjects = [
    ...
    },
    {
        ...
        description: 'Excited to share my latest project: a PDF OCR Translator built in C++! I\'ve integrated Tesseract for OCR, MuPDF for PDF handling,' +
            ...
            'A true blend of OCR and language translation tech, perfect for multilingual documents. #DeveloperLife #CodingProjects #PDFTranslator',
    ...
    ,
    {
        ...
        "githubLink": "https://psychotherapyforai.com",
...
export const ResearchMLProjects = [
    ...
    },
    {
        ...
        + "We entered into one of the Eval competitions too but didn't win :( ",
        githubLink: "http:#",
